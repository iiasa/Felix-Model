...
Description: Scripts to calculate persistence_prim data by region from world bank to 5 FeliX regions
    ...
    for raw_data_file in raw_data_files:
        ...
        if download_method == "api":
            ...
            for pos, data_point in enumerate(raw_education_):
                if "female" in data_point["series"]:
                    raw_education_[pos]["sex"] = "female"
                else:
                    raw_education_[pos]["sex"] = "male"
                if data_point["value"] == "":
...
def data_cleaning_world_bank(
    ...
    **kwargs,
    ...
    '''
        un_region   year    persistence_prim
        Africa      1950    xxxx
        Africa      1955    xxxx
        ...         ...     ...
        World       2015    xxxx
        ...
        for sex in genders:
            for year in years:
                ...
                entry = {
                    ...
                    "sex": sex,
                    "year": year,
                    "persistence_prim": raw_data_region_year[
                        "persistence_prim"
                    ].median(),
                }
...
def data_restructure(
    ...
    **kwargs,
    ...
    To restructure data into the format:
      '''
          Time,1950,1951,1952,...
          Persistence[Africa,male],x,x,x,...
          Persistence[Africa,female],x,x,x,...
          ......
          Persistence[World,male],x,x,x,...
          Persistence[World,female],x,x,x,...
      '''
    ...
    cleaned_data_by_region = cleaned_data.groupby(["un_region", "sex", "year"])
    for region in regions:
        for sex in genders:
            entry = {"parameter": f"Persistence[{region},{sex}]"}
            for year in range(1900, 2101):
                if year in year_avail:
                    ...
                    entry[year] = data_by_region["persistence_prim"].values[0] / 100
                    del data_by_region
                else:
                    entry[year] = ""
