...
Description: Scripts to calculate sec_dur data by region from world bank to 5 FeliX regions
    ...
    if kwargs:
        ...
        for region in regions:
            for year in years:
                ...
                for edu_level in ["secondary", "tertiary"]:
                ...
                if raw_data_region_year_merge.empty is False:
                    entry = {
                        ...
                        * 1000,
                        "edu_year_all": (
                            raw_data_region_year_merge["sec_dur"]
...
def data_restructure(
    ...
    **kwargs,
    ...
    To restructure data into the format:
      '''
          Time,1950,1951,1952,...
          Average Secondary Education Duration[Africa],x,x,x,...
          Average Secondary Education Duration[AsiaPacific],x,x,x,...
          ......
          Average Secondary Education Duration[WestEU],x,x,x,...
          Average Secondary Education Duration[World],x,x,x,...
      '''
    ...
    for region in regions:
        entry = {"parameter": f"Average Secondary Education Duration[{region}]"}
