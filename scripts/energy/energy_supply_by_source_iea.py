...
path_raw_data_folder = root_path_raw.joinpath(
    f"{felix_module}/Total energy supply (TES) by source country level data"
)
...
restructured_fact.to_csv(
    path_clean_data_folder.joinpath(f"total_energy_supply_by_source_by_region.csv"),
    encoding="utf-8",
    index=False,
)
