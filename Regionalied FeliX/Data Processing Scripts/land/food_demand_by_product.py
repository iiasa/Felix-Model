# -*- coding: utf-8 -*-
"""
Created: Mon 15 September 2025
Description: Scripts to aggregate food demand by product from FAOSTAT to FeliX regions
...
def data_cleaning(
    ...
    **kwargs
    ...
    print(np.unique(raw_data_merge.unit))
