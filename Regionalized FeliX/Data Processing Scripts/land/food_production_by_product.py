    ...
    **kwargs
    ...
    def name_mapping(crop_name: str):
        if crop_name in [
            ...
            return "CropMeat"
        elif crop_name in ["Milk - Excluding Butter", "Fats, Animals, Raw"]:
            return "Dairy"
...
def data_restructure(
    ...
    **kwargs,
    ...
    '''
        ...
        Potential crop production[Africa,PasMeat],x,x,x,...
        Potential crop production[AsiaPacific,PasMeat],x,x,x,...
        ...
        Potential crop production[WestEu,OtherCrops],x,x,x,...
    '''
    ...
    **kwargs
    ...
    for region in regions:
        for food_category in food_categories:
            entry = {
                "parameter (in tonnes)": f"Potential crop production[{region},{food_category}]",
            }
