...
Description: Scripts to aggregate agricultural other land area from FAOSTAT to FeliX regions
...
def data_restructure(
    ...
    **kwargs,
    ...
    '''
        ...
        Other Land[Africa],x,x,x,...
        Other Land[AsiaPacific],x,x,x,...
        ...
        Other Land[WestEu],x,x,x,...
    '''
    ...
    **kwargs
    ...
    for region in regions:
        entry = {
            "parameter (unit: ha)": f"Other Land[{region}]",
        }
...
cleaned_land = data_cleaning(raw_other_land, concordance_table)
