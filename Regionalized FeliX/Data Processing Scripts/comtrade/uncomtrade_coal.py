...
for unit in units:
    ...
    if unit == "1000 KG":
        ...
        raw_comtrade_unit["qty"] = raw_comtrade_unit["qty"] * 1.14  # convert to kg
    elif unit == "u":
        raw_comtrade_unit["qty"] = 0  # omit trade amount in unit "u"
...
def data_restructure(
    ...
    **kwargs,
    ...
    To restructure data into the format:
      '''
          Time,1950,1951,1952,...
          Coal Comtrade[Africa, Africa, Africa],x,x,x,...
          Coal Comtrade[Africa, Africa,AsiaPacific],x,x,x,...
          ......
          Coal Comtrade[WestEu, WestEU,WestEu],x,x,x,...
          Coal Comtrade[WestEu, WestEu,World],x,x,x,...
      '''
    ...
    for reporter in regions:
        for partner in regions:
            # for partner2 in regions:
            entry = {
                f"parameter": f"Coal Comtrade {unit}[{reporter},{partner},World]",
            }
